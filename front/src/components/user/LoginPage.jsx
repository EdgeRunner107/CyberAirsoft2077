...
const LoginPage = () => {
    ...
    return (
        <div className='my-5'>
            <h1 className='custom-TDS2 text-center mb-5'>로그인</h1>
            <Row className='justify-content-center '>
                <Col md={6}>
                    <Card className='p-3 mx-5 custom-TDS2 '>
                        <form onSubmit={onSubmit}>
                            <Form.Control name="uid" value={uid} onChange={onChange}
                                placeholder='아이디' className='custom-TDS2 mb-2'/>
                            <Form.Control name="upass" value={upass} onChange={onChange}
                                placeholder='비밀번호' className='custom-TDS2 mb-2' type="password"/>
                            <Button className='w-100 custom-TDS' type="submit">로그인</Button>
                        </form>
